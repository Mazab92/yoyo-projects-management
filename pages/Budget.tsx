...
const Budget: React.FC<BudgetProps> = ({ budget, onUpdate }) => {
                                ...
                                <tr key={item.id} className="bg-white border-b dark:bg-dark-secondary dark:border-gray-700">
                                    ...
                                    <td className="px-6 py-4">
                                        <div className="flex space-x-2">
                                            ...
                                            <button onClick={() => handleDelete(item)} className="text-red-500 hover:text-red-700">Delete</button>
                                        </div>
                                    </td>
                                </tr>
                            ))}
